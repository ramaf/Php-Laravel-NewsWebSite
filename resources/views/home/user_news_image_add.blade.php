            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="width:200px; height: 600px;">
                        <form action="{{route('user_image_store',['news_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <table>
                        ...
                        <table class="table" style="width: 800px">
                            ...
                            @foreach($images as $rs)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('user_image_delete',['id'=>$rs->id,'news_id'=>$data->id])}}" onclick="return confirm('Delete ! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" height="30"></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
