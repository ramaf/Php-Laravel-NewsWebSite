                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <a href="{{route('admin_faq_add')}}" style="position: absolute; right: 25px;font-style: italic; background-color:#9acffa;">Add FAQ</a>
                            <h4 class="card-title ">FAQ</h4>
                            <p class="card-category"> Here is FAQ table</p>
                        </div>
                        <div class="card-body">
