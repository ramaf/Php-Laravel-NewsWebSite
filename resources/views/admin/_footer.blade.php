...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright float-right">
            ...
            </script>, made with <i class="material-icons">favorite</i> by RAMA FARIS for a better web.
        </div>
    </div>
</footer>
</div>
        ...
        <ul class="dropdown-menu">
            ...
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('assets')}}/admin/img/sidebar-1.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('assets')}}/admin/img/sidebar-2.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('assets')}}/admin/img/sidebar-3.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('assets')}}/admin/img/sidebar-4.jpg" alt="">
                </a>
            </li>
...
<script src="{{asset('assets')}}/admin/https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
<!-- Library for adding dinamically elements -->
<script src="{{asset('assets')}}/admin/js/plugins/arrive.min.js"></script>
<!--  Google Maps Plugin    -->
<script src="{{asset('assets')}}/admin/https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
<!-- Chartist JS -->
